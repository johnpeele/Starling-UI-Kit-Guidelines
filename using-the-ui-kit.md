...
4. The UI Kit is actually separated into several different libraries, each with a specific function. You can link all or some of the Libraries to your Sketch file - they all work independantly  from each other. As of today, the libraries are:
